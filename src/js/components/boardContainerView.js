...
var boardcontainer = `
        <section class="boardsContainer m-gap padded overflow-scroll hide-scrollbar display-flex flex-row min-height-50">
            ...
            <div class="">
                <h4 id="addNewBoardButton"
                    class="full-center text-center display-flex flex-col shadow-one font-400 bg-body s-padded color-secondary fill-secondary rounded wrap cursor-pointer">
