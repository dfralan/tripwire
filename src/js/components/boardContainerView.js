...
var boardcontainer = `
        <section class="boardsContainer m-gap padded overflow-scroll hide-scrollbar display-flex flex-row min-height-50">
            ...
            <div>
                <button onclick="launchModalBoard('')" class="btn full-center text-center display-flex flex-col shadow-one font-400 bg-body s-padded color-secondary fill-secondary rounded wrap cursor-pointer">
